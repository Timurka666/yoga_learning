window.addEventListener('DOMContentLoaded', function() {
    ...
    */
    ...
    form.addEventListener('submit', function(event) {
        ...
        postData().then(() => statusMessage.innerHTML = message.loading).then(() => statusMessage.innerHTML = message.success).catch(() => statusMessage.innerHTML = message.failure).then(clearInput());
    });
